...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/providerList.html">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${pageBean.pageList}" varStatus="status">
          	...
          	<p align="right" >
					...
					<a href="${pageContext.request.contextPath}/providerList.html?pageNo=1&queryProCode=${queryProCode}&queryProName=${queryProName}">首页</a> <a
						href="${pageContext.request.contextPath}/providerList.html?pageNo=${pageBean.getPageNo() - 1}&queryProCode=${queryProCode}&queryProName=${queryProName} ">上一页</a> <a
						href="${pageContext.request.contextPath}/providerList.html?pageNo=${pageBean.getPageNo() + 1}&queryProCode=${queryProCode}&queryProName=${queryProName} ">下一页</a> <a
						href="${pageContext.request.contextPath}/providerList.html?pageNo=${pageBean.getTotalPages()}&queryProCode=${queryProCode}&queryProName=${queryProName} ">末页</a>
				</p>
    </div>
</section>
